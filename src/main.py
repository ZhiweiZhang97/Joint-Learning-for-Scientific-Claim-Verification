...
def main():
    ...
    if split:
        ...
        claim_test_path = '../data/claims_test_retrieved_arsjoint.jsonl'
    ...
    # args.model = 'model/biobert-large-cased-v1.1-mnli'
    # args.model = 'roberta-large'
    args.pre_trained_model = 'model/PreTrainingJointModel.model'
    # args.pre_trained_model = 'tmp-runs/164249858945136-abstract_f1-6022-rationale_f1-6601.model'
    args.epochs = 40
    args.bert_lr = 1e-5
    args.lr = 5e-6
    ...
    # checkpoint = 'tmp-runs/164248915725307-abstract_f1-6437-rationale_f1-6811.model'
    # print(checkpoint)
